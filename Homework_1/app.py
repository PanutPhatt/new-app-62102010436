...
OPEN_WEATHER_KEY = 'a47cd2b7e431911e1cf52032c5e5313d'

NEWS_URL = "http://newsapi.org/v2/everything?q={0}&from=2021-1-30&sortBy=publishedAt&apiKey={1}"

NEWS_KEY = "3f9a09e2092a46febac3ba21fef17969"
...
def CovidNews(): #ดึงข่าว
    url = "http://newsapi.org/v2/everything?q=tesla&from=2021-01-02&sortBy=publishedAt&apiKey=3f9a09e2092a46febac3ba21fef17969"
